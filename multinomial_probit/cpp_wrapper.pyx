...
ctypedef void (*dscal__)(const int*, const double*, double*, const int*) noexcept nogil
ctypedef double (*ddot__)(const int*, const double*, const int*, const double*, const int*) noexcept nogil
ctypedef void (*dcopy__)(const int*, const double*, const int*, double*, const int*) noexcept nogil
ctypedef void (*daxpy__)(const int*, const double*, const double*, const int*, double*, const int*) noexcept nogil
ctypedef void (*dsyr__)(const char*, const int*, const double*, const double*, const int*, double*, const int*) noexcept nogil
...
cdef public void dscal_(const int* a1, const double* a2, double* a3, const int* a4) noexcept nogil:
...
cdef public void dcopy_(const int* a1, const double* a2, const int* a3, double* a4, const int* a5) noexcept nogil:
...
cdef public void dsyr_(const char* a1, const int* a2, const double* a3, const double* a4, const int* a5, double* a6, const int* a7) noexcept nogil:
